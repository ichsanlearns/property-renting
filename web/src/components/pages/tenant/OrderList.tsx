  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-8">
        {[
          { label: "Total Volume", value: "$45,210.00", trend: "+12.5%", icon: "analytics", color: "blue" },
          { label: "Confirmed", value: "128", trend: "+4.2%", icon: "check_circle", color: "emerald" },
          { label: "Pending", value: "14", trend: "Alert", icon: "pending_actions", color: "amber" },
          { label: "Cancellations", value: "8", trend: "-1.1%", icon: "cancel", color: "rose" },
        ].map((stat, i) => (
