    ...
    <div className="flex flex-col md:flex-row gap-6">
      ...
      <div className="grow">
        <div className="flex flex-wrap items-center justify-between gap-2 mb-2">
          <div>
            <h4 className="text-lg font-bold text-slate-900 dark:text-white inline-block mr-2">
              {guest}
            </h4>
        ...
        <div className="flex items-center justify-between border-t border-slate-50 dark:border-slate-800 pt-4">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-slate-50 dark:bg-slate-800 text-primary font-bold rounded-lg text-xs hover:bg-primary hover:text-white transition-all"
          >
        ...
        {reply && (
          <div className="mt-6 pl-6 border-l-2 border-primary/20">
            <div className="flex items-start gap-4 bg-slate-50 dark:bg-slate-800/50 p-4 rounded-xl">
              <div className="shrink-0 w-8 h-8 rounded-full bg-primary flex items-center justify-center text-white text-[10px] font-bold">
                TP
              </div>
              <div>
      ...
      <section className="p-8 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4">
          ...
          <div className="flex gap-2">
            ...
            <button className="px-4 py-2 bg-primary text-white font-bold rounded-lg shadow-lg shadow-primary/20 hover:scale-[1.02] transition-transform text-sm">
              Manage Properties
            </button>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-xl p-6 border border-slate-100 dark:border-slate-800">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="material-symbols-outlined text-[#ffb300] text-2xl">
              star
            </span>
          </div>
        ...
        <div className="bg-slate-100 dark:bg-slate-900/50 rounded-2xl p-4 flex flex-wrap items-center justify-between gap-4 mb-8">
          <div className="flex items-center gap-3">
            <div className="flex bg-white dark:bg-slate-800 rounded-xl p-1 gap-1">
              ...
              <button className="px-3 py-1.5 text-xs font-bold rounded-lg text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors">
                5 ★
              </button>
              <button className="px-3 py-1.5 text-xs font-bold rounded-lg text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors">
                4 ★
        ...
        <div className="mt-12 flex items-center justify-center gap-2">
          ...
          <button className="w-10 h-10 flex items-center justify-center rounded-lg border border-slate-200 text-slate-600 font-bold hover:bg-slate-100 transition-colors">
            2
          </button>
          <button className="w-10 h-10 flex items-center justify-center rounded-lg border border-slate-200 text-slate-400 hover:bg-slate-100 transition-colors">
