...
const KPICard = ({
  ...
  <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-[32px_0_48px_-4px_rgba(25,28,30,0.06)] group hover:translate-y-[-2px] transition-all duration-300 border border-slate-50 dark:border-slate-800">
    <div className="flex justify-between items-start mb-4">
      ...
      {change && (
        <span className="text-emerald-600 bg-emerald-50 dark:bg-emerald-900/20 px-2 py-1 rounded-md text-xs font-bold">
          {change}
        </span>
      )}
    </div>
        ...
        <div className="px-10 py-8">
          ...
          <section className="mb-10">
            ...
            <p className="text-slate-500 dark:text-slate-400 font-medium text-lg">
              Here's what's happening across your premium properties today.
            </p>
          </section>
          ...
          <div className="grid grid-cols-12 gap-8 mb-10">
            ...
            <div className="col-span-12 lg:col-span-8 bg-white dark:bg-slate-900 p-8 rounded-xl shadow-sm border border-slate-100 dark:border-slate-800">
              <div className="flex justify-between items-end mb-10">
                <div>
                  ...
                  <p className="text-slate-500 text-sm font-medium">
                    Financial performance across Q1-Q3
                  </p>
                </div>
                <div className="flex space-x-2">
                  <button className="px-4 py-1.5 bg-slate-100 dark:bg-slate-800 text-xs font-bold rounded-md">
                    Daily
                  </button>
                  <button className="px-4 py-1.5 bg-[#b52330] text-white text-xs font-bold rounded-md">
                    Monthly
                  </button>
                </div>
              </div>
              <div className="h-64 relative pt-4">
                ...
                >
                  <path
                    d="M0,80 Q10,75 20,60 T40,65 T60,40 T80,30 T100,10 L100,100 L0,100 Z"
                    fill="rgba(181, 35, 48, 0.1)"
                  ></path>
                  <path
            ...
            <div className="col-span-12 lg:col-span-4">
              <div className="relative h-full min-h-[400px] rounded-xl overflow-hidden shadow-lg flex flex-col justify-end p-8 text-white">
                ...
                <div className="relative z-10">
                  <span className="inline-block px-3 py-1 bg-[#b52330] text-[10px] font-bold uppercase tracking-widest rounded-full mb-4">
                    Spotlight: High Yield
                  </span>
                  <h4 className="text-2xl font-black font-headline mb-2">
                    Penthouse VIII
                  </h4>
                  <p className="text-sm text-slate-300 mb-6 font-medium">
                    Reaching record occupancy levels this month with 98% booking
                    rate.
                  </p>
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="bg-slate-50 dark:bg-slate-800/50">
                    <th className="px-8 py-4 font-bold uppercase tracking-wider text-slate-500 text-[10px]">
                      Property
                    </th>
                    <th className="px-8 py-4 font-bold uppercase tracking-wider text-slate-500 text-[10px]">
                      Guest
                    ...
                    <th className="px-8 py-4 font-bold uppercase tracking-wider text-slate-500 text-[10px] text-right">
                      Status
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                  <tr className="hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                    ...
                    <td className="px-8 py-5 text-right">
                      <span className="bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400 px-3 py-1 rounded-full text-[10px] font-black uppercase">
                        Confirmed
                      </span>
                    </td>
                  </tr>
