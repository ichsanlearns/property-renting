    ...
    <div className="p-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-slate-500 mt-1">
          Manage and monitor all tenant bookings and payments across your
          property portfolio.
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-4 mb-6 shadow-sm">
        <div className="flex flex-wrap items-center gap-4">
          <div className="flex items-center gap-2 p-1 bg-slate-100 dark:bg-slate-800 rounded-lg overflow-x-auto max-w-full">
            <button className="px-4 py-1.5 text-sm font-semibold rounded-md bg-white dark:bg-slate-700 shadow-sm text-primary">
              All
            </button>
            {[
              "Waiting Payment",
              ...
              <button
                key={tab}
                className="px-4 py-1.5 text-sm font-medium rounded-md text-slate-600 dark:text-slate-400 hover:text-slate-900"
              >
                {tab}
              </button>
            ))}
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              ...
              <input
                className="pl-9 pr-4 py-2 text-sm border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 rounded-lg w-48"
                readOnly
                type="text"
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden shadow-sm">
            ...
            <thead>
              <tr className="bg-slate-50 dark:bg-slate-800/50 border-b border-slate-200 dark:border-slate-800">
                {[
                  ...
                  <th
                    key={header}
                    className={`px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider ${header === "Actions" ? "text-right" : ""}`}
                  >
                    {header}
                  </th>
                ))}
                ...
                >
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button className="px-3 py-1.5 text-xs font-semibold text-primary hover:bg-primary/10 rounded-md">
                        Review
                      </button>
                      <button className="p-1.5 text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 material-symbols-outlined">
                        visibility
                      </button>
                    </div>
                  </td>
        ...
        <div className="px-6 py-4 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button className="px-3 py-1 text-sm border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 rounded-md text-slate-400 cursor-not-allowed">
              Previous
            </button>
            <button className="px-3 py-1 text-sm bg-primary text-white rounded-md">
              1
            </button>
            <button className="px-3 py-1 text-sm border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 rounded-md text-slate-600 dark:text-slate-400 hover:bg-slate-50">
              2
            </button>
            <button className="px-3 py-1 text-sm border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 rounded-md text-slate-600 dark:text-slate-400 hover:bg-slate-50">
              Next
        ...
        {[
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <div
                className={`size-10 rounded-full flex items-center justify-center bg-${stat.color}-100 dark:bg-${stat.color}-900/30 text-${stat.color}-600 dark:text-${stat.color}-400`}
              >
                <span className="material-symbols-outlined">{stat.icon}</span>
              </div>
              <span
                className={`text-[10px] font-bold uppercase ${stat.trend.includes("-") ? "text-rose-500" : "text-emerald-500"}`}
              >
                {stat.trend}
              </span>
            </div>
