      ...
      <div className="bg-white rounded-3xl p-6 shadow-xl">
        ...
        <div className="space-y-4 text-sm">
          <div className="flex justify-between gap-4">
            ...
            <span className="font-semibold text-slate-900">{formatRupiah(pricePerNight * nights)}</span>
          </div>
          ...
          <div className="border-t pt-4 flex justify-between items-center">
            ...
            <span className="text-2xl font-black text-primary">{formatRupiah(totalAmount)}</span>
          </div>
        </div>
        ...
        <div className="mt-5 rounded-2xl bg-slate-50 border border-slate-200 p-4 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">Powered by StayHub & Midtrans</p>
          </div>
        </div>

        <p className="text-center text-xs text-slate-400 mt-5">By continuing, you agree to our booking terms.</p>
      </div>
    </div>
  );
}
