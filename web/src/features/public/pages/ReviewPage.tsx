      ...
      <div className="max-w-xl w-full flex flex-col gap-10">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-slate-500 dark:text-slate-400 font-medium">
            Your feedback helps the StayHub community make better choices.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl p-5 shadow-sm border border-slate-200 dark:border-slate-800 flex items-center gap-5">
          <div
            className="w-24 h-24 md:w-32 md:h-24 bg-cover bg-center rounded-xl shadow-inner shrink-0"
            style={{
              backgroundImage:
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl text-center shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-800">
            <p className="font-bold text-slate-900 dark:text-white mb-6 text-lg">
              Overall Experience
            </p>
          ...
          <div className="flex flex-col gap-3">
            <button
              type="submit"
              className="w-full bg-primary text-white py-4 rounded-2xl font-bold text-lg hover:bg-primary/90 hover:shadow-lg hover:shadow-primary/30 transition-all active:scale-[0.98]"
            >
              Submit Review
            </button>
            <button
              ...
              type="button"
              className="w-full bg-transparent text-slate-400 font-bold py-2 hover:text-slate-600 transition-colors text-sm"
            >
              Skip for now
            </button>
          </div>
